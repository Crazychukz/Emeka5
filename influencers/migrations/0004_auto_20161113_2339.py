# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-11-13 22:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('influencers', '0003_auto_20161113_2252'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='noisemakerprofile',
            name='preferences',
            field=models.CharField(choices=[('Fashion and Lifestyle', 'Fashion and Lifestyle'), ('Sports, Politics and Education', 'Sports, Politics and Education'), ('Technology', 'Technology')], max_length=1, null=True),
        ),
        migrations.AlterField(
            model_name='noisemakerprofile',
            name='twitter_handle',
