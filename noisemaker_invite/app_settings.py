...
class AppSettings(object):
    ...
    def SIGNUP_REDIRECT(self):
        ...
        return self._setting('SIGNUP_REDIRECT', 'influencers/account/register/')
    ...
    def EMAIL_SUBJECT_PREFIX(self):
        ...
        """
        return self._setting("EMAIL_SUBJECT_PREFIX", 'Noisemakerz Invitation')
    @property
    def DEFAULT_FROM_EMAIL(self):

        return self._setting("DEFAULT_FROM_EMAIL", 'Noisemakers')
