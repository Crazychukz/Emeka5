...
class SendInvite(LoginRequiredMixin, FormView):
    template_name = 'noisemaker_invite/forms/_invite.html'
    ...
    def post(self, *args, **kwargs):
        ...
        if not invitation:
            ...
            get_invitations_adapter().add_message(
                self.request,
                messages.ERROR,
                'noisemaker_invite/messages/invite_invalid.txt')
        ...
        if invitation.accepted:
            get_invitations_adapter().add_message(
                self.request,
                messages.ERROR,
                'noisemaker_invite/messages/invite_already_accepted.txt',
        ...
        if invitation.key_expired():
            get_invitations_adapter().add_message(
                self.request,
                messages.ERROR,
                'noisemaker_invite/messages/invite_expired.txt',
                {'email': invitation.email})
...
def accept_invitation(invitation, request, signal_sender):
    ...
    get_invitations_adapter().add_message(
        request,
        messages.SUCCESS,
        'noisemaker_invite/messages/invite_accepted.txt',
        {'email': invitation.email})
